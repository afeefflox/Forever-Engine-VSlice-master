...
class ChartLoader
{
	...
	public static function makeEvent(event:Array<Dynamic>, i:Int)
	{
		var subEvent:SwagEvent = {
			strumTime: event[0] - Init.trueSettings['Offset'],
			name: event[1][i][0],
			values: [event[1][i][1], event[1][i][2], event[1][i][3], event[1][i][4]]
		};
