...
@:build(haxe.ui.ComponentBuilder.build("assets/exclude/ui/chart-editor/dialogs/upload-vocals.xml"))
...
@:build(haxe.ui.ComponentBuilder.build("assets/exclude/ui/chart-editor/dialogs/upload-vocals-entry.xml"))
