...
import meta.state.editors.charting.dialogs.ChartEditorBaseDialog;
 ...
 */
@:build(haxe.ui.ComponentBuilder.build("assets/exclude/ui/chart-editor/dialogs/welcome.xml"))
...
class ChartEditorWelcomeDialog extends ChartEditorBaseDialog
{
  ...
  public function new(state2:ChartEditorState, params2:DialogParams)
  {
    ...
    this.splashImportChartMaru.onClick = _ -> onClickLinkImportChartMaru();
