...
import meta.state.editors.charting.commands.SetFreeplayPreviewCommand;
import meta.ui.components.WaveformPlayer;
...
@:build(haxe.ui.ComponentBuilder.build("assets/exclude/ui/chart-editor/toolboxes/freeplay.xml"))
class ChartEditorFreeplayToolbox extends ChartEditorBaseToolbox
{
  ...
  public function performPreview():Void
  {
    ...
    audioPreviewTracks.fadeIn(FADE_IN_DURATION, FADE_IN_START_VOLUME * freeplayPreviewVolume,
      FADE_IN_END_VOLUME * freeplayPreviewVolume, null);
  }
  ...
  public override function update(elapsed:Float)
  {
    ...
    if (isPerformingPreview && audioPreviewTracks.playing)
    {
      var startFadeOutTime = chartEditorState.currentSongFreeplayPreviewEnd - (FADE_OUT_DURATION * Constants.MS_PER_SEC);
      ...
      if (!isFadingOutPreview && audioPreviewTracks.time >= startFadeOutTime)
      {
        ...
        audioPreviewTracks.fadeOut(FADE_OUT_DURATION, FADE_OUT_END_VOLUME * freeplayPreviewVolume, (_) -> {
