...
import gameObjects.userInterface.notes.notekind.NoteKind.NoteKindParam;
import gameObjects.userInterface.notes.notekind.NoteKind.NoteKindParamType;

/**
 * The toolbox which allows modifying information like Note Kind.
 */
@:access(meta.state.editors.charting.ChartEditorState)
@:build(haxe.ui.ComponentBuilder.build("assets/exclude/ui/chart-editor/toolboxes/note-data.xml"))
