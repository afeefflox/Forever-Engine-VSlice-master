...
import meta.state.editors.charting.commands.ChangeStartingBPMCommand;
...
@:build(haxe.ui.ComponentBuilder.build("assets/exclude/ui/chart-editor/toolboxes/difficulty.xml"))
