...
import meta.state.editors.charting.commands.SetAudioOffsetCommand;
...
@:build(haxe.ui.ComponentBuilder.build("assets/exclude/ui/chart-editor/toolboxes/offsets.xml"))
