...
import meta.state.editors.charting.dialogs.ChartEditorUploadVocalsDialog;
...
class ChartEditorDialogHandler
{
  ...
  public static function openAddVariationDialog(state:ChartEditorState, closable:Bool = true):Dialog
  {
    ...
    variationForm.onSubmit = function(_) {
      ...
      var pendingVariation:SongMetadata = new SongMetadata(dialogSongName.text, dialogVariationName.text.toLowerCase());
      pendingVariation.artist = dialogSongArtist.text;
