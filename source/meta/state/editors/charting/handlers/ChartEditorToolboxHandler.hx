...
import meta.state.editors.charting.util.ChartEditorDropdowns;
...
import meta.state.editors.charting.toolboxes.ChartEditorBaseToolbox;
import meta.state.editors.charting.toolboxes.ChartEditorMetadataToolbox;
import meta.state.editors.charting.toolboxes.ChartEditorOffsetsToolbox;
import meta.state.editors.charting.toolboxes.ChartEditorFreeplayToolbox;
import meta.state.editors.charting.toolboxes.ChartEditorEventDataToolbox;
import meta.state.editors.charting.toolboxes.ChartEditorNoteDataToolbox;
import meta.state.editors.charting.toolboxes.ChartEditorDifficultyToolbox;
