...
import meta.util.assets.SoundUtil;
...
class ChartEditorAudioHandler
{
   ...
   */
  public static function playSound(_state:ChartEditorState, path:String, volume:Float = 1.0, ?pan:Float = 0):Void
  {
    ...
    var snd:Null<FlxSound> = FlxG.sound.load(asset);
    if (snd == null) return;
