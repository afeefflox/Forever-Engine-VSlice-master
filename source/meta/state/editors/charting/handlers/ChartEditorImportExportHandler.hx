...
import haxe.io.Path;
import meta.util.FileUtil.FileWriteMode;
      ...
      ?onCancelCb:Void->Void):Void
  {
    ...
    for (variation in variations)
    {
      ...
      if (variationId == '')
      {
        ...
        {
          variationMetadata.version = data.registry.SongRegistry.SONG_METADATA_VERSION;
          variationMetadata.generatedBy = data.registry.SongRegistry.DEFAULT_GENERATEDBY;
        ...
        {
          variationChart.version = data.registry.SongRegistry.SONG_CHART_DATA_VERSION;
          variationChart.generatedBy = data.registry.SongRegistry.DEFAULT_GENERATEDBY;
