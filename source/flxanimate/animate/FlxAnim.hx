...
class FlxAnim implements IFlxDestroyable
{
	...
	**/
	...
	public var animsMap:Map<String, SymbolStuff> = new Map();
	...
	public function getAnimationList():Array<SymbolStuff>
	{
		var animList:Array<SymbolStuff> = [];

		for (anims in animsMap.keys())
		{
			animList.push(getByName(anims));
		}
