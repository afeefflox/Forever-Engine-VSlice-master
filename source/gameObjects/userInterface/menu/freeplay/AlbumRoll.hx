 ...
 */
 class AlbumRoll extends FlxSpriteGroup
 {
   ...
   public function new()
   {
     ...
     newAlbumArt = new FlxAtlasSprite(640, 360, Paths.animateAtlas('$folder/albumRoll/freeplayAlbum'));
     ...
     buildAlbumTitle('$folder/albumRoll/volume1-text');
   ...
   public function buildAlbumTitle(assetKey:String):Void
   {
     ...
     albumTitle = new FunkinSprite(925, 500).loadFrame(assetKey);
